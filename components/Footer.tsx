    ...
    <footer className="bg-[#006D77] text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-4 mt-6">
              <Link 
                ...
                className="hover:text-[#FFD166] transition-colors hover:scale-110 transform duration-200"
                aria-label="Facebook"
              >
          ...
          {/* Regions */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-[#FFD166]">Regions</h3>
            <ul className="space-y-2.5">
              {regions.map((region) => (
                <li key={region.name}>
                  <Link 
                    href={region.href} 
                    className="text-gray-200 hover:text-[#FFD166] transition-colors text-sm block hover:translate-x-1 transform duration-200"
                  >
                    {region.name}
                  </Link>
                </li>
          ...
          {/* Communities */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-[#FFD166]">Communities</h3>
            <ul className="space-y-2.5">
          ...
          {/* Help */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-[#FFD166]">Help</h3>
            <ul className="space-y-2.5">
              {helpLinks.map((link) => (
                <li key={link.name}>
                  <Link 
          ...
          {/* Legal */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-[#FFD166]">Legal</h3>
            <ul className="space-y-2.5">
              {legalLinks.map((link) => (
                <li key={link.name}>
                  <Link 
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-gray-200 text-sm flex items-center gap-2">
              <span>🇬🇭</span>
              <span>Proudly serving Ghana</span>
            </p>
          </div>
        </div>
      </div>
