...
const loadProperty = async (id: string) => {
  ...
  try {
    // Fetch property (select only fields you actually use)
    ...
    const imageUrls = (imgs ?? [])
      .map((img) => publicUrl(img.image_url))
      .filter(Boolean);
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-6 py-16">
      ...
      <p className="text-gray-600 text-center max-w-lg mb-10">
        Your property is now live. You can track performance, edit details, or
        improve visibility anytime.
      </p>
